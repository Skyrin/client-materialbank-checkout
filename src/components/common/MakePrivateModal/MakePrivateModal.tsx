...
export class MakePrivateModal extends React.Component<Props, State> {
  ...
  componentDidMount() {
    this.modalTarget = document.querySelector("#makePrivateId");
  ...
  render() {
    return (
      ...
      >
        <div id={"makePrivateId"} className={styles.modalBox}>
          ...
          <div className={styles.modalContent}>
            ...
            <div className={styles.buttonsContainer}>
              <div className={styles.createButton}>Make Private</div>
